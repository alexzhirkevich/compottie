...
//        val center = Offset(centerX, centerY).transformed(f)
...
//        val allowedCuts = mutableListOf<Float>()
//        for (delta in 0..1) {
...
//        val currVertex = Offset(vertices[i * 2], vertices[i * 2 + 1])
//        val prevVertex = Offset(vertices[prevVtxIndex * 2], vertices[prevVtxIndex * 2 + 1])
//        val nextVertex = Offset(vertices[nextVtxIndex * 2], vertices[nextVtxIndex * 2 + 1])
...
// */
//private fun calculateCenter(vertices: FloatArray): Offset {
//    var cumulativeX = 0f
//    var cumulativeY = 0f
//    var index = 0
...
//    }
//    return Offset(cumulativeX / vertices.size / 2, cumulativeY / vertices.size / 2)
//}
//
///**
...
//        corner: Offset,
//        sideStart: Offset,
//        circleSegmentIntersection: Offset,
//        otherCircleSegmentIntersection: Offset,
//        circleCenter: Offset,
//        actualR: Float
//    ): Cubic {
...
//     */
//    private fun lineIntersection(p0: Offset, d0: Offset, p1: Offset, d1: Offset): Offset? {
