...
open class Cubic internal constructor(internal val points: FloatArray = FloatArray(8)) {
    ...
    internal constructor(anchor0: Offset, control0: Offset, control1: Offset, anchor1: Offset) :
     ...
     * 1 is at anchor1
     */
    internal fun pointOnCurve(t: Float): Offset {
        val u = 1 - t
...
typealias TransformResult = Pair<Float,Float>
